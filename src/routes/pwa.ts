...
pwa.get('/manifest.json', async (c) => {
  ...
  const manifest = {
    ...
    icons: [
      { src: '/static/icon.png', sizes: '72x72',   type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '96x96',   type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '128x128', type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '144x144', type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '152x152', type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '167x167', type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '180x180', type: 'image/png', purpose: 'any' },
      { src: '/static/icon.png', sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
      { src: '/static/icon.png', sizes: '384x384', type: 'image/png', purpose: 'any' },
